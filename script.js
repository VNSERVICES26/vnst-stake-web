...
const vnstStakingAddress = "0x94bC53fD2D7915fD70A120eBfb96bB99A81fFfeF";
...
async function loadStakingData() {
    ...
    try {
        ...
        updateElementText('activeStake', web3.utils.fromWei(stakeInfo.amount, 'ether'));
        
        // Get user stats
        const userStats = await vnstStakingContract.methods.getUserStats(accounts[0]).call();
        updateElementText('directMembers', userStats.totalDirectMembers);
        updateElementText('totalEarned', web3.utils.fromWei(userStats.totalEarned, 'ether'));
        
        // Get pending rewards
        const rewards = await vnstStakingContract.methods.getPendingRewards(accounts[0]).call();
        updateElementText('pendingVNT', web3.utils.fromWei(rewards.vntReward, 'ether'));
        updateElementText('pendingUSDT', web3.utils.fromWei(rewards.usdtReward, 'ether'));
        
        // Update home page stats
        updateElementText('userStaked', web3.utils.fromWei(stakeInfo.amount, 'ether') + " VNST");
        updateElementText('vntRewards', web3.utils.fromWei(rewards.vntReward, 'ether') + " VNT");
        updateElementText('usdtRewards', web3.utils.fromWei(rewards.usdtReward, 'ether') + " USDT");
